        ...
        <div className="relative w-full overflow-hidden rounded-md">
          {isMapLoaded ? (
            ...
            <button
              ...
              className="flex h-[320px] w-full items-center justify-center bg-[color:var(--c-surface-soft)] text-[16px] font-medium text-[color:var(--c-text-strong)] transition hover:bg-[color:var(--c-surface)] sm:h-[400px] md:h-[460px] xl:h-[522px]"
              style={{ fontFamily: "Roboto, sans-serif" }}
            >
              {MAP_BUTTON_TEXT}
            </button>
