...
const SECTION_TITLE = "Работаем с любыми металлами";
const SLIDE_ALT_TEXT_TEMPLATE = (index) => `Металл ${index + 1}`;

const WorkWithAnyMetall = () => {
  const slides = useMemo(
    () =>
      Array.from({ length: 10 }, (_, i) => ({
        src: `https://picsum.photos/seed/metals-${i + 1}/720/900`,
        alt: SLIDE_ALT_TEXT_TEMPLATE(i),
      })),
    []
  );
      ...
      <div className="w-full select-none">
        <Swiper
          ...
          breakpoints={{
            ...
            640: { slidesPerView: 1.2, spaceBetween: 16, slidesOffsetBefore: 16, slidesOffsetAfter: 16 },
            768: { slidesPerView: 2, spaceBetween: 20, slidesOffsetBefore: 20, slidesOffsetAfter: 20 },
            1024: { slidesPerView: 2.4, spaceBetween: 22, slidesOffsetBefore: 22, slidesOffsetAfter: 22 },
            1280: { slidesPerView: 3, spaceBetween: 24, slidesOffsetBefore: 24, slidesOffsetAfter: 24 },
          }}
        >
...
export default WorkWithAnyMetall;
